...
public class RemoteUserRepository implements UserRepository {
  ...
  public RemoteUserRepository(AuthServiceClient authServiceClient) {
  ...
  public Optional<User> findById(String id) {
    return authServiceClient.getCoreUserById(id).map(RemoteUserRepository::mapToUser);
  }
  ...
  public Optional<User> findByUsername(String username) {
    return authServiceClient
        ...
        .map(RemoteUserRepository::mapToUser);
  }
